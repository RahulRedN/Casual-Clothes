...
if (isset($_GET['id'])) {
    ...
    // SQL Query to Get the Selected Clothes
    ...
    // Get the Individual Values of Selected Clothes
    $title = $row2['title'];
        ...
        if (isset($_POST['submit'])) {
            ...
            if (isset($_FILES['image']['name'])) {
                ...
                if ($image_name != "") {
                    ...
                    $image_name = "Clothes-Name-" . rand(0000, 9999) . '.' . $ext; // This will be renamed image
        
                    // Get the Source Path and Destination Path
                    $src_path = $_FILES['image']['tmp_name']; // Source Path
                    $dest_path = "../images/clothes/" . $image_name; // Destination Path
            ...
            if ($res3 == true) {
                // Query Executed and Clothes Updated
                $_SESSION['update'] = "<div class='success'>Clothes Updated Successfully.</div>";
                header('location:' . SITEURL . 'admin/manage-clothes.php');
            } else {
                // Failed to Update Clothes
                $_SESSION['update'] = "<div class='error'>Failed to Update Clothes.</div>";
                header('location:' . SITEURL . 'admin/manage-clothes.php');
            }
